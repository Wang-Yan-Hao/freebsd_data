...
>>>>>>> b1bb5fd9 (Processing txt files in data/doc)
  ...
  Dieses Dokument enthält eine kurze Einführung zu FreeBSD 5.3-RELEASE.
...
5.3-RELEASE und repräsentiert den aktuellen Zustand im Entwicklungszweig
5-STABLE.
...
FreeBSD ist ein auf 4.4 BSD Lite basierendes Betriebssystem für
...
für PowerPC®- (powerpc) und MIPS®-Architekturen (mips) werden zur Zeit
entwickelt. FreeBSD unterstützt viele verschiedene Geräte und Umgebungen
und kann für alle Anwendungen von der Software-Entwicklung über Spiele
...
können. Die über 11,800 Ports (vom Editor über Programmiersprachen bis
...
http://mirrorlist.FreeBSD.org/ Webseiten. Wir raten Ihnen dringend,
...
Wenn Sie die Entwicklung von 5-STABLE mitverfolgen, müssen Sie die
...
-   EARLY.TXT: Eine Migrationsanleitung für Benutzer von FreeBSD 4.X,
...
-   RELNOTES.TXT: Die begleitenden Informationen zu dieser Release
    ...
    und die Änderungen seit der letzten Version (FreeBSD 5.2.1-RELEASE).
