...
>>>>>>> b1bb5fd9 (Processing txt files in data/doc)
  ...
  Dieses Dokument enthält eine kurze Einführung zu FreeBSD 4.11-RELEASE.
...
4.11-RELEASE und repräsentiert den aktuellen Zustand im
Entwicklungszweig 4-STABLE.
...
Page vorbei. Dort erhalten Sie weitergehende Informationen, wie Sie die
...
-   RELNOTES.TXT: Die begleitenden Informationen zu dieser Release
    ...
    (4.11-RELEASE) und die Änderungen seit der letzten Version (FreeBSD
    4.10-RELEASE).
