...
>>>>>>> b1bb5fd9 (Processing txt files in data/doc)
  ...
  Dieses Dokument enthält eine kurze Einführung zu FreeBSD 4.7-RELEASE.
...
4.7-RELEASE und repräsentiert den aktuellen Zustand im Entwicklungszweig
4-STABLE.
...
-   RELNOTES.TXT: Die begleitenden Informationen zu dieser Release
    ...
    und die Änderungen seit der letzten Version (FreeBSD 4.6-RELEASE).
