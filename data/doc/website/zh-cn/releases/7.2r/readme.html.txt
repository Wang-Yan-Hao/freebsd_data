FreeBSD 7.2-RELEASE 自述

FreeBSD 项目组

版权 © 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007 FreeBSD 文档项目组

$FreeBSD: releng/7.2/release/doc/zh_CN.GB2312/readme/article.sgml 191680
2009-04-30 06:17:56Z delphij $
...
>>>>>>> b1bb5fd9 (Processing txt files in data/doc)
  ...
  这份文档对 FreeBSD 7.2-RELEASE 作了一个简短的介绍， 还包括如何获取
...
这个发行版本是 FreeBSD 7.2-RELEASE 的一个 release， 它是 7.2-STABLE
分支的最新版本。
...
是一些用一条命令就可以下载、配置、编译并安装软件的脚本。 超过 20,000 个
...
如果您正在跟随 7.2-STABLE 的开发过程， 您 必须 加入 FreeBSD-CURRENT
...
-   RELNOTES.TXT： 发行说明， 展示了相对于前一版本 (FreeBSD
    7.1-RELEASE)， FreeBSD 7.2-RELEASE 中的创新和差异。
...
FreeBSD 的这个 release 是全世界成百上千的人工作无数小时的成果。 要查看
FreeBSD 开发者和捐献者的完整列表，请查看 FreeBSD Web
站点或其镜像站点上的 “FreeBSD 捐献者名录”。

在此也要特别感谢众多的 FreeBSD 用户和全世界的测试人员， 是他们使这个
release 成为可能。
