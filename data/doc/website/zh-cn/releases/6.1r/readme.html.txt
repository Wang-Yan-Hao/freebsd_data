...
$FreeBSD: src/release/doc/zh_CN.GB2312/readme/article.sgml,v 1.1.6.2
2005/10/16 07:31:59 delphij Exp $
...
>>>>>>> b1bb5fd9 (Processing txt files in data/doc)
  ...
  　　这份文档对 FreeBSD 6.1-RELEASE 作了一个简短的介绍， 还包括如何获取
...
　　这个发行版本是 FreeBSD 6.1-RELEASE 的一个 snapshot， 它是 6.1-STABLE
分支的最新版本。
...
　　如果您正在跟随 6.1-STABLE 的开发过程， 您 必须 加入 FreeBSD-CURRENT
...
-   RELNOTES.TXT： 发行说明， 展示了相对于前一版本 (FreeBSD
    6.0-RELEASE)， FreeBSD 6.1-RELEASE 中的创新和差异。
...
-   ERRATA.TXT：发行勘误。 提供新近发现的、 发行之后发现的问题等信息，
  ...
  包含了对特定硬件体系的信息。 比如， alpha
  发行说明中可能包含某些不适用于 i386™ 的信息， 反之亦然。
  每篇文档适用的体系结构会在文档的标题处列出。
...
snapshot。要查看 FreeBSD 开发者和捐献者的完整列表，请查看 FreeBSD Web
站点或者任何一个镜像站点上的 “FreeBSD 捐献者”。

　　在此也要特别感谢众多的 FreeBSD 用户和全世界的测试人员，
没有他们就根本不会有这个 snapshot。
