...
$FreeBSD: src/release/doc/zh_CN.GB2312/readme/article.sgml,v 1.1.8.2
2005/10/16 07:35:40 delphij Exp $
...
>>>>>>> b1bb5fd9 (Processing txt files in data/doc)
  ...
  这份文档对 FreeBSD 6.0-RELEASE 作了一个简短的介绍， 还包括如何获取
...
这个发行版本是 FreeBSD 6.0-RELEASE 的一个 release， 它是 6-STABLE
分支的最新版本。
...
Intel, AMD, Cyrix 或 NexGen “x86” 的 PC 硬件 (i386)， 基于 Intel Itanium
Processor 的计算机 (ia64)， NEC PC-9801/9821 系列 PC 及其兼容机 (pc98)，
以及 UltraSPARC® 机器 (sparc64)。 支持 PowerPC® (powerpc), and MIPS®
(mips) 硬件架构的的版本也正在开发中。 FreeBSD 支持各种各样的外围设备，
...
如果您正在跟随 6-STABLE 的开发过程， 您 必须 加入 FreeBSD-CURRENT
...
-   RELNOTES.TXT： 发行说明， 展示了相对于前一版本 (FreeBSD
    5.4-RELEASE)， FreeBSD 6.0-RELEASE 中的创新和差异。
