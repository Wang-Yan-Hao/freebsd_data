...
>>>>>>> b1bb5fd9 (Processing txt files in data/doc)
  ...
  　　这份文档对 FreeBSD 6.2-RELEASE 作了一个简短的介绍， 还包括如何获取
...
　　这个发行版本是 FreeBSD 6.2-RELEASE 的一个 release， 它是 6.2-STABLE
分支的最新版本。
...
是一些用一条命令就可以下载、配置、编译并安装软件的脚本。 超过 15,000 个
...
　　如果您正在跟随 6.2-STABLE 的开发过程， 您 必须 加入 FreeBSD-CURRENT
...
-   RELNOTES.TXT： 发行说明， 展示了相对于前一版本 (FreeBSD
    6.1-RELEASE)， FreeBSD 6.2-RELEASE 中的创新和差异。
