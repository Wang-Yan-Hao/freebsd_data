...
$FreeBSD: src/release/doc/zh_CN.GB2312/readme/article.sgml,v 1.3.2.1
2007/12/09 23:37:41 delphij Exp $
...
>>>>>>> b1bb5fd9 (Processing txt files in data/doc)
  ...
  　　这份文档对 FreeBSD 7.0-RELEASE 作了一个简短的介绍， 还包括如何获取
...
　　这个发行版本是 FreeBSD 7.0-RELEASE 的一个 snapshot， 它是 7-STABLE
分支的最新版本。
...
是一些用一条命令就可以下载、配置、编译并安装软件的脚本。 超过 18,000 个
...
　　镜像站点通常会提供用于刻录 FreeBSD 发行版本的 CDROM 的 ISO
映像文件。 它们通常包括了软盘映像 (仅限支持的平台)
以及通过网络安装所需要的文件。 最后，
镜像站点通常还会提供最新发行版本对应的预编译软件包。
...
　　如果您正在跟随 7-STABLE 的开发过程， 您 必须 加入 FreeBSD-CURRENT
...
-   RELNOTES.TXT： 发行说明， 展示了相对于前一版本 (FreeBSD
    6.0-RELEASE)， FreeBSD 7.0-RELEASE 中的创新和差异。
...
　　在支持 sysinstall(8) 的平台上 (目前有 amd64、 i386、 ia64、 pc98
以及 sparc64)， 这些文档在安装时都可以通过 Documentation 菜单访问。
